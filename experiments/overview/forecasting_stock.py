...
mod_gbm_lower = lgb.Booster(model_file='../../models/gbm_lower_stock.txt')
mod_gbm_upper = lgb.Booster(model_file='../../models/gbm_upper_stock.txt')
...
lower_naive = ints_naive['Close'][0.9]['lower']
upper_naive = ints_naive['Close'][0.9]['upper']
ints_arima010 = mod_arima010.predict_interval(fh, X_test, coverage=0.9)
lower_arima010 = ints_arima010['Close'][0.9]['lower']
upper_arima010 = ints_arima010['Close'][0.9]['upper']
ints_arima111 = mod_arima111.predict_interval(fh, X_test, coverage=0.9)
lower_arima111 = ints_arima111['Close'][0.9]['lower']
upper_arima111 = ints_arima111['Close'][0.9]['upper']
ints_holt = mod_holt.predict_interval(fh, X_test, coverage=0.9)
lower_holt = ints_holt['Close'][0.9]['lower']
upper_holt = ints_holt['Close'][0.9]['upper']
...
df_lower_naive.rename(columns={'Close':'lower_Naive_1'}, inplace=True)
np.savetxt('../exp_data/stock/lower_naive.txt',df_lower_naive.values.ravel())
df_upper_naive = pd.DataFrame(upper_naive)
df_upper_naive.rename(columns={'Close':'upper_Naive_1'}, inplace=True)
np.savetxt('../exp_data/stock/upper_naive.txt',df_upper_naive.values.ravel())
df_lower_arima010 = pd.DataFrame(lower_arima010)
df_lower_arima010.rename(columns={'Close':'lower_ARIMA(0,1,0)'}, inplace=True)
np.savetxt('../exp_data/stock/lower_arima010.txt',df_lower_arima010.values.ravel())
df_upper_arima010 = pd.DataFrame(upper_arima010)
df_upper_arima010.rename(columns={'Close':'upper_ARIMA(0,1,0)'}, inplace=True)
np.savetxt('../exp_data/stock/upper_arima010.txt',df_upper_arima010.values.ravel())
df_lower_arima111 = pd.DataFrame(lower_arima010)
df_lower_arima111.rename(columns={'Close':'lower_ARIMA(1,1,1)'}, inplace=True)
np.savetxt('../exp_data/stock/lower_arima111.txt',df_lower_arima111.values.ravel())
df_upper_arima111 = pd.DataFrame(upper_arima010)
df_upper_arima111.rename(columns={'Close':'upper_ARIMA(1,1,1)'}, inplace=True)
np.savetxt('../exp_data/stock/upper_arima111.txt',df_upper_arima111.values.ravel())
df_lower_holt = pd.DataFrame(lower_holt)
df_lower_holt.rename(columns={'Close':'lower_Holt-Winters'}, inplace=True)
np.savetxt('../exp_data/stock/lower_holt.txt',df_lower_holt.values.ravel())
df_upper_holt = pd.DataFrame(upper_holt)
df_upper_holt.rename(columns={'Close':'upper_Holt-Winters'}, inplace=True)
np.savetxt('../exp_data/stock/upper_holt.txt',df_upper_holt.values.ravel())
...
np.savetxt('../exp_data/stock/lower_gbm.txt',df_lower_gbm.values.ravel())
...
np.savetxt('../exp_data/stock/upper_gbm.txt',df_upper_gbm.values.ravel())
